...
# DB = DB_Minio()
# DB.check_bucket_exists(bucket_name='vacancy_city')
# DB.stat_object(bucket_name='vacancy_city', object_name='Moscow.jpg')
# DB.list_objects(bucket_name='vacancy_city')
# DB.get_presigned_url(method='GET', bucket_name='vacancy_city', object_name='Moscow.jpg')
# DB.put_object_url(bucket_name='vacancy_city', object_name='test_mars.jpg', url='https://w.forfun.com/fetch/f5/f57c3b0c00ee0c8401dc9076b29de13e.jpeg')
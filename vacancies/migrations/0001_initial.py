# Generated by Django 4.2.4 on 2023-12-22 14:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 22, 14, 39, 39, 531705, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('employer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='employer', to='vacancies.users', verbose_name='Пользователь')),
                ('moderator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='moderator', to='vacancies.users', verbose_name='Модератор')),
            ],
            options={

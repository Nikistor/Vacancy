# Generated by Django 4.2.4 on 2023-12-21 09:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Название города', max_length=100, verbose_name='Название')),
                ('description', models.TextField(blank=True, default='Описание города', null=True, verbose_name='Описание')),
                ...
                ('image', models.ImageField(default='cities/Москва.jpg', upload_to='', verbose_name='Фото')),
            ],
            options={
                'verbose_name': 'Город',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 21, 9, 14, 44, 357051, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('cities', models.ManyToManyField(null=True, to='vacancies.city', verbose_name='Города')),
                ('moderator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderator', to=settings.AUTH_USER_MODEL, verbose_name='Модератор')),

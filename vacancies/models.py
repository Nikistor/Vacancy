...
class Vacancy(models.Model):
    ...
    employer = models.ForeignKey(Users, on_delete=models.DO_NOTHING, verbose_name="Пользователь", related_name='employer', null=True)
    moderator = models.ForeignKey(Users, on_delete=models.DO_NOTHING, verbose_name="Модератор", related_name='moderator', blank=True, null=True)
